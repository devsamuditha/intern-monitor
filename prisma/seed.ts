...
async function main() {
  ...
  // Seed SuperAdmin
  const superAdminEmail = process.env.SUPERADMIN_EMAIL || "superadmin@company.com";
  const superAdminPassword = process.env.SUPERADMIN_PASSWORD || "ChangeMeNow!";
  ...
  console.log('Seeding SuperAdmin Data...');
    ...
    data: [
      {
        ...
        details: "Platform initialized with default settings",
        timestamp: new Date(getRelativeDateStr(-5) + "T00:00:00.000Z"),
      },
      {
        id: "audit-2",
        userId: "sa-root",
        action: "user.role_change",
        details: "Elena Rostova promoted to manager",
        timestamp: new Date(getRelativeDateStr(-3) + "T10:30:00.000Z"),
      },
      {
        id: "audit-3",
        userId: "sa-root",
        action: "content.flag_resolved",
        details: "Flag content-flag-1 resolved",
        timestamp: new Date(getRelativeDateStr(-1) + "T14:00:00.000Z"),
      },
    ],
  });
  ...
  await prisma.systemSetting.createMany({
    data: [
      ...
      {
        id: "set-2",
        key: "platform.maxInternPerLead",
        value: "5",
      },
      {
        id: "set-3",
        key: "logging.enableRealtime",
        value: "true",
      },
      {
        id: "set-seed-1",
    ...
    data: [
      {
        ...
        reason: "Potential sensitive data exposure in log summary",
        status: "resolved",
        createdAt: new Date(getRelativeDateStr(-2) + "T09:00:00.000Z"),
        resolvedAt: new Date(getRelativeDateStr(-1) + "T14:00:00.000Z"),
      },
      {
        id: "flag-2",
        userId: "int-liam",
        contentId: "log-liam-1",
        contentType: "daily_log",
        reason: "Log contains unprofessional language",
        status: "pending",
        createdAt: new Date(getRelativeDateStr(-1) + "T11:00:00.000Z"),
      },
    ],
  });
