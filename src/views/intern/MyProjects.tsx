...
import { Plus, Folder, Github, ExternalLink, Tag, Edit, Sparkles, X, User as UserIcon, Lock } from 'lucide-react';
...
export const MyProjects: React.FC<MyProjectsProps> = ({ currentUser, readOnly = false }) => {
  ...
  const allInternProjects = projects;
        ...
        {showForm && (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-[10px] font-bold text-teal-100 uppercase mb-1">Cover Screenshot URL (optional)</label>
                <input 
                  type="url" 
